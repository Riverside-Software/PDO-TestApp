...
StartupMode sm4 = srv.createStartupMode2(v.id, 4, "-p mainwin.r -param PROWCINI", "TestApplication1" /* Shortcut name */, 1 /* PROWCINI */, "[JSE_ROOT][VENDOR_NAME].[PRODUCT_NAME]?version=[CURRENT_VERSION]&var1={PDO_Var1}&var={PDO_Var2}&mode={mode}[USER_MODE]" /* Base URL */, "WinGrid/SamplesExplorer/Graphics/Indicators/jupiter_icon.ico")
